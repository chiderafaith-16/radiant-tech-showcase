...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: 'Laptops',
    type: 'premium',
    specs: { ram: '16GB', storage: '512GB SSD', deviceType: 'Ultrabook' },
    description: 'Razor-thin ultrabook with 2K display and premium aluminum build.',
  },
  {
    id: 'creator-laptop',
    name: 'CreatorPro 16',
    ...
    category: 'Laptops',
    type: 'premium',
    specs: { ram: '32GB', storage: '1TB SSD', deviceType: 'Creator Laptop' },
    description: 'Designed for video editors and 3D artists with color-accurate display.',
  },
  {
    id: 'flagship-phone',
    name: 'Nova Ultra Max',
    ...
    category: 'Phones',
    type: 'premium',
    specs: { ram: '12GB', storage: '512GB', deviceType: 'Smartphone' },
    description: 'Top-tier flagship with 200MP camera, titanium frame, and satellite SOS.',
  },
  {
    id: 'fold-phone',
    name: 'FlexFold X',
    ...
    category: 'Phones',
    type: 'premium',
    specs: { ram: '12GB', storage: '256GB', deviceType: 'Foldable Phone' },
    description: 'Innovative foldable smartphone with seamless crease-free display.',
  },
  {
    id: 'gaming-monitor',
    name: 'ViewMax 27 QHD',
    ...
    category: 'Gaming',
    type: 'gaming',
    specs: { deviceType: 'Gaming Monitor' },
    description: '27-inch QHD 165Hz gaming monitor with 1ms response time and HDR600.',
  },
  {
    id: 'pro-tablet',
    name: 'NovaPad Pro 12',
    ...
    category: 'Tablets',
    type: 'premium',
    specs: { ram: '12GB', storage: '512GB', deviceType: 'Tablet' },
    description: 'Pro-grade tablet with M-series chip, stylus support, and mini-LED display.',
  },
  {
    id: 'workstation-laptop',
    name: 'PowerStation W9',
    price: 1500000,
    image: laptopImg2,
    category: 'Laptops',
    type: 'premium',
    specs: { ram: '64GB', storage: '2TB SSD', deviceType: 'Workstation' },
    description: 'Enterprise workstation laptop with ECC memory and ISV-certified GPU.',
  },
  {
    id: 'gaming-console',
    name: 'PlayNova Elite',
    ...
    category: 'Gaming',
    type: 'gaming',
    specs: { ram: '16GB', storage: '1TB SSD', deviceType: 'Gaming Console' },
    description: 'Next-gen gaming console with 4K 120fps output and backward compatibility.',
  },
  {
    id: 'smart-band',
    name: 'FitBand Slim',
    ...
    category: 'Accessories',
    type: 'wearable',
    specs: { deviceType: 'Fitness Band' },
    description: 'Slim fitness tracker with heart-rate monitoring and 14-day battery life.',
  },
  {
    id: 'premium-earbuds',
    name: 'AirSound Ultra',
    ...
    type: 'audio',
    specs: { deviceType: 'Wireless Earbuds' },
    description: 'Hi-Fi wireless earbuds with spatial audio and adaptive noise cancellation.',
  },
  {
    id: 'gaming-laptop-2',
    name: 'StormForce X15',
    ...
    type: 'gaming',
    specs: { ram: '32GB', storage: '1TB SSD', deviceType: 'Gaming Laptop' },
    description: 'Extreme gaming laptop with liquid cooling and 240Hz mini-LED display.',
  },
];
